<div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 m-3 border border-primary" id="janeiro" role="tabpanel"
    ...
    <div class="grid-cols-7 flex gap-5">
        ...
        <div>
            ...
            <select name="" class="select">
                ...
                <option value="deb">Saída</option>
                <option value="cre">Entrada</option>
            </select>
        </div>
        <div>
            ...
            <select name="" class="select w-64">
                <option value="">Selecione</option>
            </select>
        </div>
        <div>
            <label for="" class="label">Beneficiário</label>
            <input type="" name="" placeholder="Sr. José, Avó..." class="input">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="" name="" placeholder="R$ 500,00" class="input">
        </div>
        <div class=" mt-5">
            <button
