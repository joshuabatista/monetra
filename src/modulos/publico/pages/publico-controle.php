...
<body>
    <div class=" flex justify-center items-center">
        <div class="content flex flex-col w-[26rem] rounded-lg">
            ...
            <div class="max-w-md mx-auto mt-4 mb-4">
                <a id="btn-avancar" href="lancamentos" class="relative inline-flex items-center justify-center  px-2 py-2 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
